...
> This post is not a step-by-step guide and assumes comfort with a Gatsby project that's already set up including plugin(s) referenced. For a full look-through of the code, there's a link to this site's source code at the [end of the post](#references).
